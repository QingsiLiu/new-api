...
const (
	...
	// Geili 自有渠道类型：固定使用 101+ 高位段，避免与上游新增类型撞号
	// （历史上 KIE 曾用 58，与上游 AdvancedCustom 撞号；DB 迁移见 model/main.go）
	ChannelTypeKie               = 101
	ChannelTypeJimengOpenAIVideo = 102
	ChannelTypeLsSeedance        = 103
...
var ChannelBaseURLs = []string{
	...
	"",                                          //58
	101: "https://api.kie.ai",     //101 KIE
	"https://zz1cc.cc.cd",         //102 JimengOpenAIVideo
	"http://api.callxyq.xyz",      //103 LsSeedance
}
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeKie:               "KIE",
	ChannelTypeJimengOpenAIVideo: "JimengOpenAIVideo",
	ChannelTypeLsSeedance:        "Ls.API Seedance",
}
