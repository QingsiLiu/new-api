...
// updates, async task polling, and funnel maintenance into the system task
// framework so a DB lease dedups execution across multiple master instances.
...
func RegisterScheduledSystemTasks() {
	...
	service.RegisterSystemTaskHandler(funnelMaintenanceHandler{})
}
