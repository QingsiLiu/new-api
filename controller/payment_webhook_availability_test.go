...
func TestWaffoPancakeWebhookEnabledRequiresTopUpAndWebhookConfig(t *testing.T) {
	confirmPaymentComplianceForTest(t)
	t.Setenv("WAFFO_PANCAKE_ENV", "prod")
	...
	// Webhooks only require merchant credentials; Credits checkout additionally
	// requires the immutable product and store snapshots.
