  ...
  return (
    <PublicLayout showMainContainer={false}>
      <div className='relative'>
        <div
          aria-hidden
          className='bg-primary/5 pointer-events-none absolute inset-x-0 top-0 h-[600px] opacity-70 dark:opacity-25'
        />
...
function RankingsError(props: { message: string }) {
  const { t } = useTranslation()
  return (
    <div className='bg-card rounded-lg px-6 py-12 text-center shadow-[var(--shadow-card)]'>
