...
const AUDIT_TEMPLATES: Record<string, string> = {
  ...
  'user.quota_add': 'Increased user balance by {{quota}}',
  'user.quota_subtract': 'Decreased user balance by {{quota}}',
  'user.quota_override': 'Overrode user balance from {{from}} to {{to}}',
