...
const defaultModelSettings: ModelSettings = {
  ...
  AsyncFailoverEnabled: false,
  AsyncFailoverMaxAttempts: 3,
  AsyncPollTransientRetries: 3,
  AsyncCircuitEnabled: false,
  AsyncCircuitFailureThreshold: 3,
  AsyncCircuitWindowSeconds: 300,
  AsyncCircuitMinimumSamples: 10,
  AsyncCircuitSuccessRateThreshold: 40,
  AsyncCircuitInitialOpenSeconds: 60,
  AsyncCircuitProbeLeaseSeconds: 30,
  AsyncTaskAttemptRetentionDays: 180,
