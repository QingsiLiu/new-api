  ...
  return (
    <div className='space-y-4'>
      ...
      {status?.database_type === 'sqlite' && (
        <Alert className='border-warning/25 bg-warning/10 dark:border-warning/30 dark:bg-warning/15'>
          ...
          <AlertDescription>
            ...
            {isElectron && electronDataDir && (
              <p className='mt-3 rounded-md bg-warning/10 px-3 py-2 font-mono text-xs text-warning dark:bg-warning/15'>
      ...
      {status?.database_type === 'mysql' && (
        <Alert className='border-success/25 bg-success/10 dark:border-success/30 dark:bg-success/15'>
          <AlertTitle className='flex items-center gap-2'>
      ...
      {status?.database_type === 'postgres' && (
        <Alert className='border-info/25 bg-info/10 dark:border-info/30 dark:bg-info/15'>
          <AlertTitle className='flex items-center gap-2'>
