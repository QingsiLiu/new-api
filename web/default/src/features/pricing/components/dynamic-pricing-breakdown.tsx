    ...
    return (
      <section className='min-w-0 py-4'>
        <div className='mb-3 flex items-center gap-2'>
          <span className='bg-warning/10 text-warning border-warning/20 inline-flex size-6 items-center justify-center rounded-lg border'>
  ...
  return (
    <section className='min-w-0 py-3 sm:py-4'>
      <div className='mb-3 flex items-start gap-2 sm:mb-4'>
        <span className='bg-warning/10 text-warning border-warning/20 mt-0.5 inline-flex size-6 items-center justify-center rounded-lg border'>
          <TagIcon className='size-3.5' />
        </span>
        <div>
          <div className='text-foreground text-base font-medium'>
          ...
          <ul className='space-y-1.5'>
            {ruleGroups.map((group, gi) => (
              ...
              >
                ...
                <Badge
                  variant='secondary'
                  className='bg-warning/10 text-warning border-warning/20 shrink-0'
                >
                  {group.multiplier}x
                </Badge>
              </li>
