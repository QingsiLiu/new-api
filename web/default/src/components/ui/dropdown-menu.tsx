...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        'bg-popover text-popover-foreground border-border data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 w-auto min-w-[96px] rounded-xl border p-1.5 shadow-none duration-150',
        className
      )}
      align={align}
      alignOffset={alignOffset}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'text-muted-foreground group-focus/dropdown-menu-item:text-accent-foreground ml-auto font-mono text-[0.6875rem] tracking-[0.14em]',
        className
      )}
      {...props}
    />
