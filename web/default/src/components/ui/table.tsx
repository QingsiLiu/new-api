...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
      ...
      className={cn(
        'border-border/60 border-t bg-transparent font-medium [&>tr]:last:border-b-0',
        className
      )}
      {...props}
    />
  ...
  return (
    <tr
      ...
      className={cn(
        ...
        'bg-[linear-gradient(to_right,transparent_1.5rem,var(--border)_1.5rem,var(--border)_calc(100%-1.5rem),transparent_calc(100%-1.5rem))] bg-[length:100%_1px] bg-no-repeat bg-bottom',
        'last:bg-none',
        className
      )}
      {...props}
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'text-muted-foreground px-6 py-4 text-left text-xs align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&_*]:text-xs',
        className
      )}
      {...props}
    />
