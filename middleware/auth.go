...
func authHelper(c *gin.Context, minRole int) {
	...
	// Session authentication already carries the authoritative user id. The
	// header remains mandatory for access-token requests and optional for a
	// session, while a supplied value is always checked for consistency.
