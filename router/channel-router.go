...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/async-health", permission: authz.ChannelRead, handler: controller.GetAsyncChannelHealth},
	...
	{method: http.MethodPost, path: "/:id/async-circuit/reset", permission: authz.ChannelOperate, handler: controller.ResetAsyncChannelCircuit},
